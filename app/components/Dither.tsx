...
void main() {
  ...
  float vignette = 1.0 - smoothstep(0.05, 0.9, distFromCenter);
  
  vec3 col = mix(vec3(baseColor), waveColor, f);
...
interface WaveUniforms {
  ...
  baseColor: THREE.Uniform<number>;
}
...
function DitheredWaves({
  ...
  const waveUniformsRef = useRef<WaveUniforms>({
    ...
    baseColor: new THREE.Uniform(baseColor)
  });
